(function (TabFile, $, undefined) {
  ...
  TabFile.Utilities = {};
  {
    const supportedFileTypes = {
      ...
      HTML: ['eml', 'md', 'msg'],
      JPG: ['3g2', '3gp', '3gp2', '3gpp', '3mf', 'ai', 'arw', 'asf', 'avi', 'bas', 'bash', 'bat', 'bmp', 'c', 'cbl', 'cmd', 'cool', 'cpp', 'cr2', 'crw', 'cs', 'css', 'csv', 'cur', 'dcm', 'dcm30', 'dic', 'dicm', 'dicom', 'dng', 'doc', 'docx', 'dwg', 'eml', 'epi', 'eps', 'epsf', 'epsi', 'epub', 'erf', 'fbx', 'fppx', 'gif', 'glb', 'h', 'hcp', 'heic', 'heif', 'htm', 'html', 'ico', 'icon', 'java', 'jfif', 'jpeg', 'jpg', 'js', 'json', 'key', 'log', 'm2ts', 'm4a', 'm4v', 'markdown', 'md', 'mef', 'mov', 'movie', 'mp3', 'mp4', 'pdf', 'png', 'ppt', 'pptx', 'rtf', 'tiff', 'txt', 'wmv', 'xml']
    };
